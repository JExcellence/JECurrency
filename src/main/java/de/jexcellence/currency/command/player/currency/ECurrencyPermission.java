...
/**
 * Enumeration defining permission nodes for individual currency command operations within the JECurrency system.
 * <p>
...
public enum ECurrencyPermission implements IPermissionNode {
	 ...
	 * within the JECurrency plugin's permission framework.
	 * </p>
	 *
