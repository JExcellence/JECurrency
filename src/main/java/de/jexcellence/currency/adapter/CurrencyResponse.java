...
/**
 * Indicates a typical Return for an Economy method. It includes a {@link ResponseType} indicating whether the plugin currently being used for Economy
...
public record CurrencyResponse(
	...
	/**
	 * Constructor for CurrencyResponse
	 *
