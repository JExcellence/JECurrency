 ...
 * </p>
 * <ul>
 *   <li><code>jecurrency.admin.delete</code> - Specific delete permission</li>
 *   <li><code>jecurrency.admin.*</code> - All administrative permissions</li>
...
public class CurrenciesActionOverviewView extends BaseView {
	...
	/**
	 * State holder for the main JECurrency plugin instance.
	 */
	private final State<JECurrency> jeCurrency = initialState("plugin");
	...
	private void renderCreateCurrencyAction(
		...
		renderContext.layoutSlot(
			...
			clickContext.openForPlayer(
				...
				Map.of(
					"plugin",
					this.jeCurrency.get(clickContext)
				)
			);
		});
	}
	 ...
	 * <p>
	 * This button opens the {@link CurrencyIdentifierAnvilView} where users can
	 ...
	 * Currently, the functionality displays a "not implemented" message as the
	 * deletion feature is still under development.
	 * </p>
	 *
	 * <h3>Permission Requirements:</h3>
	 * <p>
	...
	private void renderDeleteCurrencyAction(
		...
		renderContext.layoutSlot(
			...
			this.handleDeleteCurrencyClick(contextPlayer);
		});
	}
	...
	private boolean hasDeletePermission(
		...
		return targetPlayer.hasPermission("jecurrency.admin.delete") ||
		       targetPlayer.hasPermission("jecurrency.admin.*") ||
		       targetPlayer.isOp();
	}
	
	/**
	 * Handles the delete currency button click event.
	 * <p>
	 * Currently displays a "not implemented" message to the player as the
	 * currency deletion functionality is still under development.
	 * </p>
	 *
	 * <h3>Future Implementation:</h3>
	 * <p>
	 * This method will be expanded to provide:
	 * </p>
	 * <ul>
	 *   <li>Currency selection interface</li>
	 *   <li>Confirmation dialog with impact assessment</li>
	 *   <li>Safe deletion with data cleanup</li>
	 *   <li>Audit logging for administrative actions</li>
	 * </ul>
	 *
	 * @param requestingPlayer the player who clicked the delete button, must not be null
	 */
	private void handleDeleteCurrencyClick(
		final @NotNull Player requestingPlayer
	) {
		this.i18n(
			    "delete_currency.not_implemented",
			    requestingPlayer
		    )
		    .includingPrefix()
		    .build()
