...
import com.raindropcentral.rplatform.misc.heads.view.Leaderboard;
 ...
 * </p>
 * <ul>
 *   <li><code>jecurrency.admin.reset</code> - Specific reset permission</li>
...
public class CurrencyDetailView extends BaseView {
	...
	public void onFirstRender(
		...
		final JECurrency pluginInstance = this.jeCurrency.get(renderContext);
	...
	private void renderResetFunction(
		...
		final @NotNull Player contextPlayer,
		final @NotNull Currency displayedCurrency,
		final @NotNull JECurrency pluginInstance
	) {
		renderContext.layoutSlot(
			'r',
	...
	private boolean hasResetPermission(
		...
		return targetPlayer.hasPermission("jecurrency.admin.reset") ||
	...
	private void handleResetAllBalances(
		...
		pluginInstance
			...
			.thenAcceptAsync(
				...
				this.jeCurrency.get(clickContext).getExecutor()
			)
